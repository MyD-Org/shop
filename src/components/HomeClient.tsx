...
/**
 * Home. `oferta` llega resuelta desde el Server Component `app/page.tsx`
 * (null = sin cuotas: flag apagado, sin datos o error).
 */
export function HomeClient({ oferta }: { oferta: OfertaCuotas | null }) {
